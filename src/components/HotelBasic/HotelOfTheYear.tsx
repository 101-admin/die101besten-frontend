  ...
  return (
    <section className="max-w-1440 mx-auto px-4 py-12">
      ...
      <div className="flex flex-wrap items-center justify-center lg:gap-16 gap-8 mt-16 px-4 lg:px-16">
        ...
        {/* <div className="relative w-[180px] lg:w-[243.83px] h-[60px] lg:h-[80px]">
          <Image
            src="/hotelbasic/image(1).svg"
            alt="FAIR"
            fill
            className="object-contain"
          />
        </div>
        <div className="relative w-[150px] lg:w-[243.83px] h-[60px] lg:h-[80px]">
          <Image
            src="/hotelbasic/image(2).svg"
            alt="HORNSTEIN"
            fill
            className="object-contain"
          />

          ...
          <div className="flex flex-col w-full max-w-[500px]">
            ...
            <div className="flex flex-col gap-4 mt-auto">
              <Link
                ...
                href={`/${ctaButton?.url}`}
              >
                <button className="w-full h-14 sm:h-16 gap-2 py-4 px-6 bg-black text-white uppercase font-montserrat font-bold text-sm sm:text-base leading-6 text-center tracking-normal hover:bg-gray-800 transition-colors">
